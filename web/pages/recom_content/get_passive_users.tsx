...
function GetActiveUsers() {
  ...
  useEffect(() => {
    dispatch(menuActions.setMenu("/recom_content/get_passive_users"))
  ...
  return (router.isFallback)
    ...
    : <>
      <InfoComponent projectName="컨텐츠 추천" functionName="Passive 유저 조회" desc={ Description }/>
      <NoParamForm
        endpointApi={ "/api/recom_content/get_passive_users" }
        style={{ margin: "30px 0" }}
      />
      <Divider/>
